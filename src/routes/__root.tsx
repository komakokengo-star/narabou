...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "福岡行列代行 — 博多・天神の人気店、並ぶのは私たち" },
      { name: "description", content: "福岡・博多・天神の人気店に並ぶ代行サービス。基本800円から10分200円で受付。" },
      { property: "og:title", content: "福岡行列代行" },
      { property: "og:description", content: "博多・天神の人気店に並ぶ代行サービス。" },
